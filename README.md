...
2. Change `task_view` in its url to `task_text`, in the browser address line, like this:
        www.codeabbey.com/index/task_view/sum-of-two
        to
        http://www.codeabbey.com/index/task_text/sum-of-two
...
4. Go to [Issues](https://github.com/CodeAbbey/Corrections/issues) of this project and click "new issue".
